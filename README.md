...
Команда разработки:
- :white_check_mark: [Vlaldis95 (в роли Python-разработчика Тимлид - разработчик 1)](https://github.com/Vlaldis95)
- :white_check_mark: [ivanshtuber (в роли Python-разработчика - разработчик 2)](https://github.com/ivanshtuber)
- :white_check_mark: [Nikta210 роль (в роли Python-разработчика - разработчик 3)](https://github.com/Nikta210)
...
- Установите и активируйте виртуальное окружение c учетом версии Python 3.79 (выбираем python не ниже 3.9):
